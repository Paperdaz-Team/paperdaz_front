    ...
    <d-card-body :class="[computedBodyClass]">
      <div :class="['d-flex', computedInnerWrapperClass]">
        <div :class="['stats-small__data', computedDataFieldClass]">
          <span
            :class="['stats-small__label', 'text-uppercase', computedLabelClass]">{{ label }}</span>
        ...
        <div
          :class="['stats-small__data', computedInnerDataFieldClass]"
          v-if="percentage">
          <span
            :class="['stats-small__percentage', `stats-small__percentage--${computedPercentageModifier}`]">{{ percentage }}</span>
        </div>
      </div>
      <canvas
